...
public class ClassProgramVarDeclaration extends ProgramVarDeclarationPart {

    private ClassDecl ClassDecl;

    public ClassProgramVarDeclaration (ClassDecl ClassDecl) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("ClassProgramVarDeclaration(\n");
