...
public class VarProgramVarDeclaration extends ProgramVarDeclarationPart {

    private GlobalVarDecl GlobalVarDecl;

    public VarProgramVarDeclaration (GlobalVarDecl GlobalVarDecl) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("VarProgramVarDeclaration(\n");
